...
BrewHeaterEvent.prototype.retrieveAll = function(request, response) {
  this._findBrew(request.params.brewId, request, function(brew) {
    ...
    response(null, brew.heaterEvents);
  }.bind(this));
};

BrewHeaterEvent.prototype.create = function(request, response) {
  this._findBrew(request.params.brewId, request, function(brew) {
